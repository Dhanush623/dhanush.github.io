...
function displayPurchasedItems(purchasedItems) {
  ...
  purchasedItems.products.forEach(item => {
    ...
    var brSpanOne = document.createElement("br");
    listItem.appendChild(brSpanOne);

    var priceSpan = document.createElement("span");
    priceSpan.textContent = "Quantity: " + item.quantity;
    priceSpan.id = "quantity";
    listItem.appendChild(priceSpan);

    var brSpanTwo = document.createElement("br");
    listItem.appendChild(brSpanTwo);

    var linkSpan = document.createElement("span");
    linkSpan.textContent = "Product Link: " + item.link;
    linkSpan.id = "link";
